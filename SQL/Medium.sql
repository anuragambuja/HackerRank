--The_PADS   https://www.hackerrank.com/challenges/the-pads/problem
...
-- Binary_Tree_Nodes  https://www.hackerrank.com/challenges/binary-search-tree-1/problem
...
-- Weather_Observation_Station_18   https://www.hackerrank.com/challenges/weather-observation-station-18/problem 

select round((max(LAT_N) - min(LAT_N) + max(LONG_W) - min(LONG_W)), 4) from station;

-- Weather_Observation_Station_19 https://www.hackerrank.com/challenges/weather-observation-station-19/problem

select round(sqrt((a-b)*(a-b)+(c-d)*(c-d)), 4)
from (select min(LAT_N) a, max(LAT_N) b, min(LONG_W) c, max(LONG_W) d from station);

-- Weather_Observation_Station_20   https://www.hackerrank.com/challenges/weather-observation-station-20/problem
